...
namespace CaseLabBase.DAL
{
    public class CaseLabBaseDbContext : DbContext
    {
        public CaseLabBaseDbContext(DbContextOptions<CaseLabBaseDbContext> options) : base(options)
        {
        }
