-- Create CaseLabDB database for Microsoft SQL Server (run in SSMS)
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'CaseLabDB')
BEGIN
    CREATE DATABASE CaseLabDB;
END
GO
...
PRINT 'CaseLabDB initialized — no quiz seed data. Create your first quiz from the Instructor Dashboard!';
GO
